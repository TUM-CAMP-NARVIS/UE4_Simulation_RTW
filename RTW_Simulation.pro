...
unrealRootPath=/home/aro/Development/UnrealEngine
RTW_SimulationRootPath=/home/aro/Documents/Unreal Projects/RTW_Simulation

gameProjectFile=/home/aro/Documents/Unreal Projects/RTW_Simulation/RTW_Simulation.uproject
...
include(RTW_SimulationSource.pri)
include(RTW_SimulationHeader.pri)
include(RTW_SimulationConfig.pri)
include(RTW_SimulationIncludes.pri)
include(RTW_SimulationDefines.pri)
...
RTW_Simulation-Linux-Debug.commands = $$build RTW_Simulation Linux Debug  -project="\"$$gameProjectFile\"" $$args
RTW_Simulation-Linux-DebugGame.commands = $$build RTW_Simulation Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
RTW_Simulation-Linux-Shipping.commands = $$build RTW_Simulation Linux Shipping  -project="\"$$gameProjectFile\"" $$args
RTW_Simulation-Linux-Test.commands = $$build RTW_Simulation Linux Test  -project="\"$$gameProjectFile\"" $$args
RTW_Simulation.commands = $$build RTW_Simulation Linux Development  -project="\"$$gameProjectFile\"" $$args

RTW_SimulationEditor-Linux-Debug.commands = $$build RTW_SimulationEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
RTW_SimulationEditor-Linux-DebugGame.commands = $$build RTW_SimulationEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
RTW_SimulationEditor-Linux-Shipping.commands = $$build RTW_SimulationEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
RTW_SimulationEditor-Linux-Test.commands = $$build RTW_SimulationEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
RTW_SimulationEditor.commands = $$build RTW_SimulationEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	RTW_Simulation-Linux-Debug \
	RTW_Simulation-Linux-DebugGame \
	RTW_Simulation-Linux-Shipping \
	RTW_Simulation-Linux-Test \
	RTW_Simulation \
	RTW_SimulationEditor-Linux-Debug \
	RTW_SimulationEditor-Linux-DebugGame \
	RTW_SimulationEditor-Linux-Shipping \
	RTW_SimulationEditor-Linux-Test \
	RTW_SimulationEditor \
