...
RTW_Simulation-Linux-Debug:
	 $(PROJECTBUILD) RTW_Simulation Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_Simulation-Linux-DebugGame:
	 $(PROJECTBUILD) RTW_Simulation Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_Simulation-Linux-Shipping:
	 $(PROJECTBUILD) RTW_Simulation Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_Simulation-Linux-Test:
	 $(PROJECTBUILD) RTW_Simulation Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_Simulation:
	 $(PROJECTBUILD) RTW_Simulation Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_SimulationEditor-Linux-Debug:
	 $(PROJECTBUILD) RTW_SimulationEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_SimulationEditor-Linux-DebugGame:
	 $(PROJECTBUILD) RTW_SimulationEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_SimulationEditor-Linux-Shipping:
	 $(PROJECTBUILD) RTW_SimulationEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_SimulationEditor-Linux-Test:
	 $(PROJECTBUILD) RTW_SimulationEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RTW_SimulationEditor:
	 $(PROJECTBUILD) RTW_SimulationEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
